...
const TextImageBlockA = (props) => (
  <div className="bg-black text-white">
    <div className="row gx-0 flex-lg-row flex-column-reverse align-items-center">
      ...
      <div className="col col-12 col-lg-6 p-4 p-lg-5 text-centerm-rightd">
	  	  <h2 className="font-f-akira text-red">{props.title}</h2>
        <p>{props.paragraph}</p>
	    </div>
    </div>
  </div>
